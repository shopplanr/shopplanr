    ...
    return (
        ...
        >
            ...
            >
                ...
                <span className="text-sm font-medium">{t('signup.goBack')}</span>
            </Button>
            <div className="max-w-md w-full relative z-10">
                <div className="text-center mb-8">
                    <img src={logo} alt="logo" className="h-13 mx-auto mb-4" />
                    <p className="text-text opacity-60">{t('signup.subtitle')}</p>
                </div>
                ...
                <form onSubmit={handleSignup} className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-text mb-1">{t('signup.email')}</label>
                        <input
                            type="email"
                            value={email}
                    ...
                    <div>
                        <label className="block text-sm font-medium text-text mb-1">{t('signup.password')}</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-text mb-1">{t('signup.confirmPassword')}</label>
                        <div className="relative">
                            <input
                            ...
                            {confirmPassword && (
                                ...
                                >
                                    <Icon size="16">
                                        {showConfirmPassword ? <EyeOff20Regular /> : <Eye20Regular />}
                                    </Icon>
                                </button>
                            )}
                        </div>
                    ...
                    <div className="text-center mt-6">
                        <p className="text-text/70 text-sm">
                            {t('signup.hasAccount')}{' '}
                            <Link to="/login" className="text-accent font-semibold hover:text-primary transition-colors">
                                {t('signup.logIn')}
                            </Link>
                        </p>
                    </div>
